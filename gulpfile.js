...
function browsersyncInit(done) {
  browsersync.init({
    ...
    // Off: click/scroll/form mirroring across connected clients double-fires
    // delegated handlers (e.g. the theme toggle) when the docs are open in more
    // than one tab / device / the BrowserSync UI.
    ghostMode: false,
  });
  done();
}
